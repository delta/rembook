...
/***/ function(module, exports, __webpack_require__) {
	...
	var RemBook = __webpack_require__(4);
	var Rem = __webpack_require__(10);

	var ProfilePageComponent = __webpack_require__(14);
	var RemsComponent = __webpack_require__(16);
	var WriteRemPageComponent = __webpack_require__(18);
	var ConditionallyEditableComponent = __webpack_require__(20);
	var ConditionallyEditableTextAreaComponent = __webpack_require__(22);
	var NavComponent = __webpack_require__(25);
	var SearchControlComponent = __webpack_require__(27);
	var SearchResultsComponent = __webpack_require__(29);
	var ImageUploaderComponent = __webpack_require__(31);
	var InstructionsComponent = __webpack_require__(33);
	...
	_vue2.default.filter('isFinalYear', function (str) {
		return RemBook.isFinalYear(str);
	});

	function displayLoader() {
		$("body").append("<div id='rem-loader' style='position:absolute;top:0;left:0;right:0;bottom:0;'><div class='ui active dimmer'><div class='ui loader'></div></div></div>").show();
	}
	function hideLoader() {
		$("#rem-loader").remove();
	}
	...
	function navigateToPage(page) {
		...
		updateNav();
		if (page <= 1) {
			if (safelyTurnPageTo(rollNumber, page)) RemBookRouter.navigate(rollNumber + "/profile");
		} else {
			if (safelyTurnPageTo(rollNumber, page)) RemBookRouter.navigate(rollNumber + "/rems/" + (page - 1));
		}
	}

	function safelyTurnPageTo(rollNumber, page) {
		if (!bookBlock || bookBlock.bookblock('isActive')) return false;
		if (!RemBook.currentRemBookOf || RemBook.currentRemBookOf.attributes.rollNumber != rollNumber) displayLoader();
	...
	function bookBlockKeyHandler(e) {
		...
		if (writeRemPageComponent.isopen || imageUploaderComponent.isopen || instructionsComponent.isopen || searchResultsComponent.isopen) return true;
	...
	function renderRems(all) {
		var m = RemBook.currentRemBookOf.Rems.models.map(function (r) {
			return r.attributes;
		});
		...
		remsComponent = new RemsComponent({
			...
			methods: {
				'togglePrint': function togglePrint(e) {
					e.target.blur();
					var id = e.target.id.match(/print#(.+)$/)[1];
					var cur = this.rems.find(function (x) {
						return x.id == id;
					});
					var that = this;
					displayLoader();
					$.ajax({
						...
						dataType: "json",
						success: function success(returned) {
							hideLoader();
				...
				'toggleApprove': function toggleApprove(e) {
					var cur = this.rems.find(function (x) {
		...
		new ProfilePageComponent({
			...
			events: {
				change: function change(e) {
					if (/hostel\#/i.test(e.dataId)) changeHostel(e);else if (/question\#/.test(e.dataId)) changeBio(e);else if (e.dataId != 'dob') changeRegularProfile(e);
				},
				blur: function blur(e) {
					if (e.dataId == "dob") changeRegularProfile(e);
				}
			},
			methods: {
				_onImageSave_: function _onImageSave_() {
				...
				toggleHardCopy: function toggleHardCopy(e) {
					e.target.blur();
					var that = this;
	...
	var _RemBookRouter = _backbone2.default.Router.extend({
		routes: {
			"(/)": "root",
			"login(/)": "root",
		...
		"rems": function rems(rollNumber, page) {
			if (!RemBook.isFinalYear(rollNumber)) return this.navigate(rollNumber + "/profile/", { replace: true });
	...
	searchControlComponent = new SearchControlComponent({
		...
		methods: {
			...
			oninput: function oninput(e) {
				if (this._isDebouncing_) return;else {
	...
	writeRemPageComponent = new WriteRemPageComponent({
		...
		methods: {
			...
			onsave: function onsave(e, highlight) {
	...
	imageUploaderComponent = new ImageUploaderComponent({
		...
		methods: {
			load: function load(e, aspectRatio) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notifications = __webpack_require__(11);
	...
	RemBook = {
		...
		search: new Search(),
		_usersCache_: _defineProperty({}, currentUser.rollNumber, currentUser),
		loadRemBook: function loadRemBook(rollNumber, cb) {
			var that = this;
		...
		loadRemPage: function loadRemPage(rollNumber, page, cb) {
			var that = this;
		...
		isFinalYear: function isFinalYear(rollNumber) {
			rollNumber += "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rems = __webpack_require__(9);
		...
		fetch: function fetch(options) {
			...
			(function () {
				...
				function _success(model, response, opt) {
					counter++;
					counter == 3 && options && options.success && options.success(that);
				}
				function _error(model, response, opt) {
					!error_raised && options && options.error && options.error(that, response, opt) && (error_raised = true);
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	try {
		for (var _iterator = Object.keys(__RemBookInit__.questions)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var key = _step.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rem = Backbone.Model.extend({
		...
		parse: function parse(obj) {
			...
			try {
				for (var _iterator2 = obj.responses[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					var q = _step2.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = Backbone.Collection.extend({
		...
		url: function url() {
			...
			if (this.params.department) s += "&department=" + this.params.department;
			return s;
		},
		...
		setDepartment: function setDepartment(d) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfilePageComponent = _vue2.default.extend({
					template: __webpack_require__(15),
					computed: {
									_isEditable_: function _isEditable_() {
													return this.profile.lastLogin !== undefined;
									}
					}
	});

	_vue2.default.component('profilepage-component', ProfilePageComponent);
	_vue2.default.filter('formatDateForInputEl', function (val) {
					if (!val) return "";
					val = new Date(val);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RemsComponent = _vue2.default.extend({
	    template: __webpack_require__(17)
	});

	_vue2.default.component('rems-component', RemsComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WriteRemPageComponent = _vue2.default.extend({
	    template: __webpack_require__(19),
	    computed: {}
	});

	_vue2.default.component('write-rem-page-component', WriteRemPageComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConditionallyEditableComponent = _vue2.default.extend({
	  props: ['dataId', 'data', 'placeholder', 'placeholderInput', 'placeholderEmpty', 'limit', 'editable', 'type', 'characterCount'],
	  template: __webpack_require__(21),
	  computed: {},
	  methods: {
	    onfocusdummy: function onfocusdummy(e) {
	      $(e.target).hide();
	      $(this.$el).find("._real_").show().focus();
	    },
	    onblurreal: function onblurreal(e) {
	      $(e.target).hide();
	...
	_vue2.default.component('conditionally-editable-component', ConditionallyEditableComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2.default.component('conditionally-editable-text-area-component', ConditionallyEditableTextAreaComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	!function (e, t) {
		...
		}var a = null;"undefined" == typeof window || "function" != typeof window.getComputedStyle ? (a = function a(e) {
			return e;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavComponent = _vue2.default.extend({
	    template: __webpack_require__(26),
	    computed: {
	        finalYear: function finalYear() {
	...
	_vue2.default.component('nav-component', NavComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchControlComponent = _vue2.default.extend({
	...
	module.exports = SearchControlComponent;

/***/ },
/* 28 */
/***/ function(module, exports) {

	module.exports = "<div class=\"search-container-container twelve wide column\">\n\t<div class=\"search-container ui fluid left icon input big\">\n\t\t<input type=\"text\" placeholder=\"Search your friends...\" v-on:focus=\"onsearchfocus($event)\" v-on:input=\"oninput($event)\">\n\t\t<i class=\"search icon\"></i>\n\t</div>\n</div>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchResultsComponent = _vue2.default.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageUploaderComponent = _vue2.default.extend({
		template: __webpack_require__(32)
	});

	_vue2.default.component('image-uploader-component', ImageUploaderComponent);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"image-uploader-component\">\n\t<div class=\"topbar\">\n\t\t<div class=\"button-container\">\n\t\t<button class=\"ui labeled icon primary button\" v-on:click=\"save($event)\">\n\t\t\t<i class=\"save icon\"></i>\n\t\t\tSave\n\t\t</button>\n\t\t<button class=\"ui labeled icon button\" v-on:click=\"onclose($save)\">\n\t\t\t<i class=\"cancel icon\"></i>\n\t\t\tCancel\n\t\t</button>\n\t\t</div>\n\t</div>\n\t<div class=\"container\">\n\t\t<div class=\"anothercontainer\"><img class=\"original\" /></div>\n\t</div>\n</div>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InstructionsComponent = _vue2.default.extend({
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"search-results-container\">\r\n\t<div class=\"topbar\">\r\n\t\t<h2 class=\"ui header\" style=\"margin: auto\"></h2>\r\n\t\t<i class=\"ui right floated close icon big\" v-on:click=\"onclose($event)\"></i>\r\n\t</div>\r\n\r\n\t<div class=\"content\">\r\n\t\t<h2 class=\"ui header\" style=\"margin: auto\">Instructions</h2><br><br>\r\n\t\t1. This is a Rem<i>Book</i>, so you can flip pages. Use left and right arrow keys.<br><br>\r\n\t\t2. If using mobile, you can swipe left and right to turn pages<br><br>\r\n\t\t3. Everything gets autosaved. There isn't any save button!<br><br>\r\n\t</div>\r\n</div>\r\n"
