...
/***/ function(module, exports, __webpack_require__) {
	...
	function onChangeBook() {
		...
		function changeRegularProfile(e) {
			if (e.dataId == "dob" && $(e.DOMEvent.target).parent().find("input[type=date]").has(":focus").length) return setTimeout(function () {
		...
		new ProfilePageComponent({
			...
			events: {
				change: function change(e) {
					if (/hostel\#/i.test(e.dataId)) changeHostel(e);else if (/question\#/.test(e.dataId)) changeBio(e);else changeRegularProfile(e);
				}
			}
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConditionallyEditableComponent = _vue2.default.extend({
	  props: ['dataId', 'data', 'placeholder', 'placeholderInput', 'placeholderEmpty', 'maxlength', 'editable', 'type'],
